                ...
                for (let block of blocks) {
                    ...
                    if (nameLine) {
                        ...
                        if (blockName.toLowerCase() === root.sinkName.trim().toLowerCase()) {
                            ...
                            const descriptionLine = block.split('\n').find(function(l) {
                                return l.trim().startsWith('Description:');
                            });
                            if (descriptionLine) {
                                root.sinkDescription = descriptionLine.split(':')[1].trim();
                            }
                ...
                for (let block of blocks) {
                    ...
                    if (nameLine) {
                        ...
                        if (blockName.toLowerCase() === root.sourceName.trim().toLowerCase()) {
                            ...
                            if (descriptionLine) {
                                root.sourceDescription = descriptionLine.split(':')[1].trim();
                            }
